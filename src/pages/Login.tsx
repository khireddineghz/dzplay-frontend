      ...
      <form action="#" className="space-y-6">
        ...
        <div className="mt-10 text-center">
            <p className="text-base text-gray-500 dark:text-gray-400">
                New to the game? 
                <a href="/signup" className="font-bold text-primary hover:text-primary-dark ml-1 underline decoration-primary/30 hover:decoration-primary decoration-2 underline-offset-4 transition-all">Create an account</a>
            </p>
        </div>
      </form>
    </AuthLayout>
